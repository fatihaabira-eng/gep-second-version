        ...
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="flex items-center">
            <Link to="/" className="flex-shrink-0 flex items-center">
              ...
              <span className="font-sans text-xl font-bold text-[#3a6a6e] tracking-tight ml-2">
                GEP Dashboard
              </span>
            </Link>
          </div>
          ...
          <div className="hidden md:flex md:items-center">
            <NavigationMenu className="mr-4">
              <NavigationMenuList>
                ...
                <NavigationMenuItem>
                  <NavigationMenuTrigger className={isActive("/countries") ? "bg-[#6cb154]/10 text-[#6cb154] font-semibold" : ""}>
                    Countries
                  </NavigationMenuTrigger>
                  <NavigationMenuContent>
                    <ul className="grid w-[400px] gap-3 p-4 md:w-[500px] md:grid-cols-2">
                      <li className="row-span-3">
                        <NavigationMenuLink asChild>
                          <Link to="/countries" className="flex h-full w-full select-none flex-col justify-end rounded-md bg-gradient-to-b from-[#3a6a6e]/20 to-[#6cb154]/20 p-6 no-underline outline-none focus:shadow-md">
                            <div className="mb-2 mt-4 text-lg font-medium text-[#3a6a6e]">
                              Countries
                            </div>
                      ...
                      <li>
                        <Link to="/countries" className="block select-none space-y-1 rounded-md p-3 leading-none no-underline outline-none transition-colors hover:bg-[#6cb154]/10 focus:bg-[#6cb154]/10">
                          <div className="text-sm font-medium leading-none text-[#3a6a6e]">All Countries</div>
                      ...
                      <li>
                        <Link to="/countries?region=africa" className="block select-none space-y-1 rounded-md p-3 leading-none no-underline outline-none transition-colors hover:bg-[#6cb154]/10 focus:bg-[#6cb154]/10">
                          <div className="text-sm font-medium leading-none text-[#3a6a6e]">Africa</div>
                          <p className="text-sm leading-snug text-gray-500">
                      ...
                      <li>
                        <Link to="/countries?region=asia" className="block select-none space-y-1 rounded-md p-3 leading-none no-underline outline-none transition-colors hover:bg-[#6cb154]/10 focus:bg-[#6cb154]/10">
                          <div className="text-sm font-medium leading-none text-[#3a6a6e]">Asia</div>
                          <p className="text-sm leading-snug text-gray-500">
          ...
          <div className="hidden md:flex items-center">
            <div className="relative mx-4">
              ...
              <input
                type="text"
                placeholder="Search..."
                className="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md bg-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-[#6cb154] focus:border-[#6cb154] sm:text-sm"
              />
            </div>
            {/* <Link
              to="/signin"
              className="px-4 py-2 text-sm font-medium rounded-md text-white bg-[#0f7378] hover:bg-[#08565a] focus:ring-2 focus:ring-offset-2 focus:ring-[#0f7378] transition-colors"
            >
              Sign In
            </Link> */}
          </div>
            ...
            <ul className="bg-white space-y-2 py-2 shadow-md">
              ...
              <li className="px-4 py-2">
                ...
                <Link 
                  ...
                  className="block w-full text-center py-2 text-sm font-medium rounded-md text-white bg-[#0f7378] hover:bg-[#08565a]"
                >
                  Sign In
                </Link>
              </li>
